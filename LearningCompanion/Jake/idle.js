...
(lib.idle = function() {
	...
	this.idleChar.setTransform(119,257.6,1,1,0,0,0,119,257.6);
...
(lib.jakechairidle = function() {
	...
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#000000").ss(1,1,1).p("");
	this.shape_1.setTransform(160.5,211.6);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("#000000").ss(1,1,1).p("");
	...
	this.shape_7.graphics.f("#968150").s().p("");
	...
	this.shape_9.graphics.f("#D3BFA5").s().p("");
