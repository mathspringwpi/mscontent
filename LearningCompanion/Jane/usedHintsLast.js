...
lib.properties = {
	...
	color: "#FFFFFF",
	manifest: [
		{src:"sounds/UsedHintsLast.mp3" || "sounds/UsedHintsLast.ogg", id:"UsedHintsLast"}
	]
};
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	// actions
	this.text = new cjs.Text("I am glad you're making\ngood use of hints!\nKeep up the good work!", "16px 'Helvetica'", "#282415");
	...
	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#76782D").s().p("");
...
// stage content:
(lib.usedHintsLast_Canvas = function() {
	this.initialize();
