...
lib.properties = {
	...
	color: "#FFFFFF",
	manifest: [
		{src:"sounds/SecondChoice.mp3" || "sounds/SecondChoice.ogg", id:"SecondChoice"}
	]
};
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	// actions
	this.text = new cjs.Text("Well, that didn't work.\n\nWhat is our second\nchoice of things to try?", "16px 'Helvetica'", "#282415");
...
// stage content:
(lib.SecondChoice_Canvas = function() {
	this.initialize();
