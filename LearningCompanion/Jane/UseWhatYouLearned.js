...
lib.properties = {
	...
	color: "#FFFFFF",
	manifest: [
		{src:"sounds/UseWhatYouLearned.mp3" || "sounds/UseWhatYouLearned.ogg", id:"UseWhatYouLearned"}
	]
};
...
(lib.gjanemouthside = function(mode,startPosition,loop) {
	...
	this.shape_41.graphics.f().s("#BE8552").ss(0.5,1,1).p("ABBgKQADgFABgEQADgIgDgCQgBgBgDgBQgJgCgVABQgaABgeACQgeACgLAFIgHgFQgCgFADgIQAPADAKAAQALABAUgJQAHAEARABQATABANADQAOADAHACABCgMQgBABAAABABCgMQgFAHgEAFQgBAAAAAAQgMAQgDADQgPARhCgDIgBgGQgGACAAADQgBAFABAEQACAEAtAAQAsABAVg4QgCAFgEAFIgBAAIABAAQABgCAGgKg");
	...
	this.shape_55.graphics.f().s("#000000").ss(0.5,1,1).p("AAwghIAAABIhYAjIAAgBAgnAiQABgKACgEIBbgrIABgBAg2gKQAKAFAEAHAg4gKQALAFAFAH");
	...
	this.shape_90.graphics.f().s("#000000").ss(0.5,1,1).p("AAugZQANAAAOgBABGgbIABABABEgcIABABAgyAdQAAgPAAgHIAEgCQANgBAMgBQgLgEgNgPQgFABgIACIgOgKAAugCQANAAANgBAAugCQAEgNAAAAQgBgDgDgHAgVADQAbgDAogCAgtgQQAmgHA1gC");
	...
	this.shape_132.graphics.f().s("#BE8552").ss(0.5,1,1).p("");
	...
	this.shape_135.graphics.f("#FFFFFF").s().p("AgeAEQgGAAgCADIgEgQQAFABAUAAQARABAqAEIAAABIAAgBIABAAIgBABQgZALgdABQgMgFgGgBgAAqgDg");
	this.shape_135.setTransform(-3.4,0);

	this.shape_136 = new cjs.Shape();
	this.shape_136.graphics.f("#402424").s().p("AAMAKIgCACIACgCQgNAEgIgEIgSgIQAegCAZgLIAAAAIAAAAIAAAAIAAAAQgHARgLAGIgCAAIAAAAIAEgCg");
	this.shape_136.setTransform(-1.9,0.9);

	this.shape_137 = new cjs.Shape();
	this.shape_137.graphics.f().s("#BE8552").ss(0.5,1,1).p("");
...
(lib.UseWhatYouLearned_1 = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});

	// timeline functions:
	this.frame_0 = function() {
		playSound("UseWhatYouLearned");
	}
	...
	// actions
	this.text = new cjs.Text("Great!\nNow use what you\n learned to help you\n solve this one.", "16px 'Helvetica'", "#282415");
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({scaleY:1,x:141.4,y:145.1},1).to({regX:-1.1,scaleX:0.95,scaleY:0.95,x:141.3},2).to({regX:-1.2,scaleX:0.86,scaleY:0.7,x:141,y:145.2},5).to({scaleX:0.79,scaleY:1,x:140.6,startPosition:20},4).wait(2).to({scaleX:1,x:142.2},0).to({rotation:-7,x:141.5,y:145.1},3).to({regX:-1.1,regY:2,rotation:-8,x:142.6,startPosition:36},6).wait(6).to({regX:-1.2,regY:1.9,rotation:-7,x:141.5,startPosition:20},0).to({startPosition:20},1).wait(2).to({regX:-1.1,regY:2.1,scaleX:1.32,scaleY:0.93,rotation:0,skewX:8.5,skewY:3.1,x:147.2,y:145.8,startPosition:29},0).wait(2).to({scaleX:1.01,scaleY:1,skewX:0,skewY:0,x:146.1,y:145.7,startPosition:20},0).wait(2).to({scaleX:1.32,scaleY:0.93,skewX:8.5,skewY:3.1,x:147.2,y:145.8,startPosition:29},0).wait(4).to({scaleX:0.96,x:146.6,y:145.3,startPosition:1},0).wait(1).to({startPosition:0},0).wait(6).to({regX:-1.2,regY:1.9,scaleX:1.02,scaleY:0.87,skewX:0,skewY:0,x:147.5,y:145.4,startPosition:12},0).wait(5).to({scaleX:0.93,scaleY:1,x:144.9,startPosition:24},0).wait(1).to({scaleX:1.02,scaleY:0.87,x:147.5,startPosition:12},0).wait(5).to({startPosition:12},0).wait(5).to({regX:-1.1,regY:2.1,scaleX:1.01,scaleY:0.93,x:147.7,y:145.1},0).wait(2).to({scaleX:1.32,scaleY:0.93,skewX:8.5,skewY:3.1,x:147.2,y:145.8,startPosition:29},0).wait(2).to({scaleX:0.96,x:146.6,y:145.3,startPosition:1},0).wait(1).to({startPosition:0},0).wait(4).to({scaleX:1.01,scaleY:0.93,skewX:0,skewY:0,x:146.1,y:145.7,startPosition:24},0).wait(2).to({scaleY:1},0).wait(4).to({startPosition:20},0).wait(8).to({scaleX:1.32,scaleY:0.93,skewX:8.5,skewY:3.1,x:147.2,y:145.8,startPosition:29},0).wait(1).to({regX:-1.2,regY:1.9,scaleX:1.02,scaleY:0.87,skewX:0,skewY:0,x:147.5,y:145.4,startPosition:12},0).wait(3).to({regX:-1.1,regY:2.1,scaleX:1.01,scaleY:0.93,x:147.7,y:145.1},0).wait(4).to({regX:-1.2,regY:2,scaleX:1,scaleY:1.14,rotation:-7,x:147.5,y:144.2,startPosition:37},0).wait(7));
	...
	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f().s("#000000").ss(1,1,1).p("");
	this.shape_14.setTransform(137.9,171.8);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#A4211E").s().p("AA/goQg4gXhcgPQg9gHgDA5IgFAAIgCgJIgBAAIgHgQIgCgEIgNgYIgIgRIgBgBIgcgwIgJgRQAsAVA7gNQAQgLAPgQQASAfA2AQQB2AhA1grIACAFIARA4IACAGQAPAuATArIADAIIAQAoQgDAeAAAYIgSBIQgth8hhhkg");
	this.shape_15.setTransform(151.6,227.6);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#E3CFA4").s().p("");
	this.shape_16.setTransform(163.7,196.2);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#FFFFFF").s().p("AnPK8IABAAIACAEgAHNDYIABgBIACAGgACUiRIAAAAIACABgADqkSIAAgHIADgFIAFAAIgHAOgAB6moIgBgBIACABIAAAAIgBABgAB1nlIAAgBIABABgAAVq9IgBgCIACACIgBAAg");
	this.shape_17.setTransform(120.7,191.3);
	...
	this.shape_18.setTransform(149.9,211.2);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#76782D").s().p("");
	this.shape_19.setTransform(166.5,204.6);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#9FA156").s().p("");
	this.shape_20.setTransform(165.1,194.7);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#FEE3BC").s().p("");
	this.shape_21.setTransform(131.7,179.8);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#B66616").s().p("");
	this.shape_22.setTransform(148.7,122.6);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f().s("#000000").ss(1,1,1).p("");
	...
	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.f("#FFFFFF").s().p("AnxK8IABAAIACAEgAHgIkIAAAAIAAAAgAGrDYIABgBIACAGgAHxASIAAAAIABAAgACBhxIAAAAIAAAAgAByiRIAAAAIACAAgADIkSIAAgHIADgFIAFAAIgHANgABYmoIgBgBIACAAIAAABIgBABgABTnmIABAAIgBABIAAgBgAgLq9IgBgCIACABIgBABIAAAAg");
	...
	this.shape_28 = new cjs.Shape();
	this.shape_28.graphics.f("#76782D").s().p("");
	this.shape_28.setTransform(167.5,204.5);

	this.shape_29 = new cjs.Shape();
	this.shape_29.graphics.f("#9FA156").s().p("");
	...
	this.shape_31 = new cjs.Shape();
	this.shape_31.graphics.f("#B66616").s().p("");
	this.shape_31.setTransform(149.7,122.6);

	this.shape_32 = new cjs.Shape();
	this.shape_32.graphics.f().s("#000000").ss(1,1,1).p("");
	...
	this.shape_36 = new cjs.Shape();
	this.shape_36.graphics.f("#9FA156").s().p("");
	this.shape_36.setTransform(166.1,194.7);

	this.shape_37 = new cjs.Shape();
	this.shape_37.graphics.f("#FEE3BC").s().p("");
	this.shape_37.setTransform(132.7,178.4);

	this.shape_38 = new cjs.Shape();
	this.shape_38.graphics.f("#FAEED3").s().p("AgtAAQgGAWgDAZIgDALIAAAAQgCAIgFAAQABgkASgegAA+g/QABgBAAAAQAAAAABAAQAAgBABAAQAAAAABABIgDABg");
	this.shape_38.setTransform(129.8,96.9);

	this.shape_39 = new cjs.Shape();
	this.shape_39.graphics.f("#B66616").s().p("");
	this.shape_39.setTransform(151.7,121.8);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_22},{t:this.shape_21},{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.instance_3}]}).to({state:[{t:this.shape_31},{t:this.shape_30},{t:this.shape_29},{t:this.shape_28},{t:this.shape_27},{t:this.shape_26},{t:this.shape_25},{t:this.shape_24},{t:this.shape_23}]},14).to({state:[{t:this.shape_39},{t:this.shape_38},{t:this.shape_37},{t:this.shape_36},{t:this.shape_35},{t:this.shape_27},{t:this.shape_34},{t:this.shape_33},{t:this.shape_24},{t:this.shape_32}]},18).wait(69));
...
// stage content:
(lib.UseWhatYouLearned_Canvas = function() {
	this.initialize();

	// Layer 1
	this.instance = new lib.UseWhatYouLearned_1();
