...
lib.properties = {
	...
	color: "#FFFFFF",
	manifest: [
		{src:"sounds/HintUseful.mp3" || "sounds/HintUseful.ogg", id:"HintUseful"}
	]
};
...
(lib.HintUseful_1 = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});

	// timeline functions:
	this.frame_0 = function() {
		playSound("HintUseful");
	}
	...
	// actions
	this.text = new cjs.Text("This is the moment\nwhen a hint can be\nvery useful.", "16px 'Helvetica'", "#282415");
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape},{t:this.text}]},1).to({state:[]},99).wait(1));
	...
	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f().s("#000000").ss(0.5,1,1).p("ABCACQgFAAgEgCQgCAAgCgDABJAAQgDgBgBgCQgCgFAAgDABZgDQgDgDAAgDQAAgCAAgDABpgDQABgGgBgDAB/AHQgCgFAAgDAhoAIQgGgFgDgDQgDgBAAgDAhaACQgBgCgCgBQgBAAgBgBQgBgBgBgCAhJAAQgCAAgBgBQgCgFAAgFAhyAPQgGgCgDgDQgEgDABgE");
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(7).to({_off:false},0).to({scaleY:1,x:141.4,y:145.1},4).to({regX:-1.1,scaleX:0.95,scaleY:0.95,x:141.3},6).to({regX:-1.2,scaleX:0.86,scaleY:0.7,x:141,y:145.2},5).to({scaleX:0.79,scaleY:1,x:140.6,startPosition:20},4).wait(2).to({scaleX:1,x:142.2},0).to({rotation:-7,x:141.5,y:145.1},3).to({scaleX:0.79,rotation:0,x:140.6,y:145.2},5).wait(10).to({scaleX:1.02,scaleY:0.87,x:147.5,y:145.4,startPosition:12},0).wait(6).to({scaleX:0.93,scaleY:1,x:144.9,startPosition:24},0).wait(1).to({scaleX:1.02,scaleY:0.87,x:147.5,startPosition:12},0).wait(5).to({startPosition:12},0).wait(5).to({regX:-1.1,regY:2.1,scaleX:1.01,scaleY:0.93,x:147.7,y:145.1},0).wait(2).to({scaleX:1.32,scaleY:0.93,skewX:8.5,skewY:3.1,x:147.2,y:145.8,startPosition:29},0).wait(2).to({scaleX:0.96,x:146.6,y:145.3,startPosition:1},0).wait(1).to({startPosition:0},0).wait(4).to({scaleX:1.01,scaleY:0.93,skewX:0,skewY:0,x:146.1,y:145.7,startPosition:24},0).wait(2).to({scaleY:1},0).wait(4).to({startPosition:20},0).wait(8).to({scaleX:1.32,scaleY:0.93,skewX:8.5,skewY:3.1,x:147.2,y:145.8,startPosition:29},0).wait(1).to({regX:-1.2,regY:1.9,scaleX:1.02,scaleY:0.87,skewX:0,skewY:0,x:147.5,y:145.4,startPosition:12},0).wait(3).to({regX:-1.1,regY:2.1,scaleX:1.01,scaleY:0.93,x:147.7,y:145.1},0).wait(4).to({regX:-1.2,regY:2,scaleX:1,scaleY:1.14,rotation:-7,x:147.5,y:144.2,startPosition:37},0).wait(7));
	...
	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#76782D").s().p("");
...
// stage content:
(lib.HintUseful = function() {
	this.initialize();

	// Layer 1
	this.instance = new lib.HintUseful_1();
