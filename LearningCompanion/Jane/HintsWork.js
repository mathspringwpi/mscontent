...
lib.properties = {
	...
	color: "#FFFFFF",
	manifest: [
		{src:"sounds/HintsWork.mp3" || "sounds/HintsWork.ogg", id:"HintsWork"}
	]
};
...
(lib.gjanemouthside = function(mode,startPosition,loop) {
	...
	this.shape_41.graphics.f().s("#BE8552").ss(0.5,1,1).p("ABBgfQgJgCgVABQgaABgeACQgeACgLAFIgHgFQgCgFADgIQAPADAKAAQALABAUgJQAHAEARABQATABANADQAOADAHACgABBgKQADgFABgEQADgIgDgCQgBgBgDgBABCgMQgBABAAABQgCAFgEAFIgBAAIABAAQABgCAGgKQgFAHgEAFQgBAAAAAAQgMAQgDADQgPARhCgDIgBgGQgGACAAADQgBAFABAEQACAEAtAAQAsABAVg4");
...
(lib.HintsWork_1 = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(14).call(this.frame_14).wait(86).call(this.frame_100).wait(1));

	// actions
	this.text = new cjs.Text("Great job!\n\nSee, the hints do work!", "16px 'Helvetica'", "#282415");
	this.text.textAlign = "center";
	this.text.lineHeight = 17;
	this.text.lineWidth = 175;
	this.text.setTransform(121.9,-28.7);
	...
	// jane eyes
	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("#000000").ss(0.5,1,1).p("ABCgFQgCAAgDgBQgIgCgGgEABPgKQgBgBgCgBQgBgBgBgBQgDgBgCgBABjgIQgFgDgFABAhOAOQgBgBAAAAIgBgBQgDgCgDgBQgBAAAAgBQgCgBgDgBAhTARIAAAAQgCAAgCAAQgIAAgDgFAhCAOQgEgEgEgDAA6ACIAAAAQgNACgIgI");
	...
	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f().s("#000000").ss(0.5,1,1).p("AhAAFQgFAAgEACAhPAKIAAAAQgDABgBABQgIABgEAAAhLAIQgBAAgBAAIgBAAQgEABgDAAQAAAAgBAAQgCAAgDABABVgKQAGgBAFACAA6gGIAAAAQgMABgKgDABAgIQgDAAgCgBQgJAAgHgCABMgKQgCAAgBgBQgCAAgBAAQgDgBgDAA");
	this.shape_9.setTransform(137,126);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f().s("#000000").ss(1,1,1).p("AhlALQABgBADgBQABgBACAAQAAgBAAAAQAEgBAFAAQABgBABAAQABAAABAAIABAAQACgBADAAQAFAAAHABABmgBQgPgGgNgCQgCAAgCAAQgCgBgCAAQgBAAgBAAQgFAAgFAAQgCABgCAAQgFAAgDABQgEABgCAC");
	this.shape_10.setTransform(139.1,125.9);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f().s("#000000").ss(0.5,1,1).p("ABJAAQgDgBgBgCQgCgFAAgDABCACQgFAAgEgCQgCAAgCgDABZgDQgDgDAAgDQAAgCAAgDABpgDQABgGgBgDAB/AHQgCgFAAgDAhoAIQgGgFgDgDQgDgBAAgDAhaACQgBgCgCgBQgBAAgBgBQgBgBgBgCAhJAAQgCAAgBgBQgCgFAAgFAhyAPQgGgCgDgDQgEgDABgE");
	this.shape_11.setTransform(144.4,122.7);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f().s("#000000").ss(1,1,1).p("AAtgBIAGgGIACgCIAFgDIACgBQAHgBAHAAQADgBADAAQAFAAAFABQAIACAIAFQADABADADQAGADAFADQAFAGACAHAiBAFQgBgBABgBQABgCAJgCQADgCAEgCQABgBACAAIAEgBIARgCIAFAAQAEACAFAEQAFADADAH");
	this.shape_12.setTransform(145.9,123.9);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f().s("#8F6910").ss(1,1,1).p("ACQAVQgYgVgUgKQgegOgjAFAiPAWQAJgQAPgHQATgLAXAB");
	this.shape_13.setTransform(145.3,115);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("Ah2AVIgBgEQgFgFgDgLIgCgGQAAAAAAAAQAAgBAAAAQAAAAAAgBQAAAAAAAAQABgCAJgEIAHgEIADgBQgIAPAFAPIACAKIgIgBgAA6ALQgMgFAAgTIAFgGIACgCQgBATAMAPIgGgCgABrgPIAMAIQAHAGAEAFQgNADgJAAQADgHgEgPg");
	this.shape_14.setTransform(145.9,125.1);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#474B70").s().p("AhtAPQgFgPAIgPIAEgBIARgCIAFAAQAEACAFAEQAFAEADAIQAEAHgGAIIgCAGIgoAEIgCgKgABLASIgIgCQgMgQABgSIAFgDIACgBIAOgBIAGgBIAKABQAIACAIAFIABAEQAEAPgEAHIAAABIgEAEQgPAEgJAAIgHgBg");
	this.shape_15.setTransform(145.6,124.8);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4}]}).to({state:[{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_4},{t:this.shape_5}]},14).to({state:[{t:this.shape_6},{t:this.shape_10},{t:this.shape_9}]},26).to({state:[{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11}]},6).wait(55));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(14).to({_off:false},0).to({scaleY:1,x:141.4,y:145.1},1).to({regX:-1.1,scaleX:0.95,scaleY:0.95,x:141.3},2).to({regX:-1.2,scaleX:0.86,scaleY:0.7,x:141,y:145.2},5).to({scaleX:0.79,scaleY:1,x:140.6,startPosition:20},4).wait(2).to({scaleX:1,x:142.2},0).to({rotation:-7,x:141.5,y:145.1},3).to({regX:-1.1,regY:2,rotation:-8,x:142.6,startPosition:36},1).wait(14).to({regX:-1.2,scaleY:1.14,rotation:-7,x:147.5,y:144.2,startPosition:37},0).wait(6).to({regY:1.9,scaleX:0.93,scaleY:1,rotation:0,x:144.9,y:145.4,startPosition:24},0).wait(1).to({scaleX:1.02,scaleY:0.87,x:147.5,startPosition:12},0).wait(5).to({startPosition:12},0).wait(5).to({regX:-1.1,regY:2.1,scaleX:1.01,scaleY:0.93,x:147.7,y:145.1},0).wait(2).to({scaleX:1.32,scaleY:0.93,skewX:8.5,skewY:3.1,x:147.2,y:145.8,startPosition:29},0).wait(2).to({scaleX:0.96,x:146.6,y:145.3,startPosition:1},0).wait(1).to({startPosition:0},0).wait(4).to({scaleX:1.01,scaleY:0.93,skewX:0,skewY:0,x:146.1,y:145.7,startPosition:24},0).wait(2).to({scaleY:1},0).wait(4).to({startPosition:20},0).wait(8).to({scaleX:1.32,scaleY:0.93,skewX:8.5,skewY:3.1,x:147.2,y:145.8,startPosition:29},0).wait(1).to({regX:-1.2,regY:1.9,scaleX:1.02,scaleY:0.87,skewX:0,skewY:0,x:147.5,y:145.4,startPosition:12},0).wait(3).to({regX:-1.1,regY:2.1,scaleX:1.01,scaleY:0.93,x:147.7,y:145.1},0).wait(4).to({regX:-1.2,regY:2,scaleX:1,scaleY:1.14,rotation:-7,x:147.5,y:144.2,startPosition:37},0).wait(7));
	...
	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f().s("#000000").ss(1,1,1).p("");
	...
	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#E3CFA4").s().p("");
	...
	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#76782D").s().p("");
	this.shape_21.setTransform(166.5,204.6);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#9FA156").s().p("");
	...
	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.f("#B66616").s().p("");
	this.shape_24.setTransform(148.7,122.6);

	this.shape_25 = new cjs.Shape();
	this.shape_25.graphics.f().s("#000000").ss(1,1,1).p("");
	...
	this.shape_30 = new cjs.Shape();
	this.shape_30.graphics.f("#76782D").s().p("");
	this.shape_30.setTransform(167.5,204.5);

	this.shape_31 = new cjs.Shape();
	this.shape_31.graphics.f("#9FA156").s().p("");
	...
	this.shape_33 = new cjs.Shape();
	this.shape_33.graphics.f("#B66616").s().p("");
	this.shape_33.setTransform(149.7,122.6);

	this.shape_34 = new cjs.Shape();
	this.shape_34.graphics.f().s("#000000").ss(1,1,1).p("");
	...
	this.shape_37 = new cjs.Shape();
	this.shape_37.graphics.f("#76782D").s().p("");
	this.shape_37.setTransform(167.5,204.5);

	this.shape_38 = new cjs.Shape();
	this.shape_38.graphics.f("#9FA156").s().p("");
	...
	this.shape_41 = new cjs.Shape();
	this.shape_41.graphics.f("#B66616").s().p("");
	this.shape_41.setTransform(151.7,121.8);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_24},{t:this.shape_23},{t:this.shape_22},{t:this.shape_21},{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.instance_3}]}).to({state:[{t:this.shape_33},{t:this.shape_32},{t:this.shape_31},{t:this.shape_30},{t:this.shape_29},{t:this.shape_28},{t:this.shape_27},{t:this.shape_26},{t:this.shape_25}]},14).to({state:[{t:this.shape_41},{t:this.shape_40},{t:this.shape_39},{t:this.shape_38},{t:this.shape_37},{t:this.shape_29},{t:this.shape_36},{t:this.shape_35},{t:this.shape_26},{t:this.shape_34}]},32).wait(55));
...
// stage content:
(lib.HintsWork_Canvas = function() {
	this.initialize();

	// Layer 1
	this.instance = new lib.HintsWork_1();
