...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 39350, function(sym, e) {
         maybeStop(sym)

      });
      //Edge binding end

      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 61373, function(sym, e) {
         maybeStop(sym)

      });
      //Edge binding end

      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 84198, function(sym, e) {
         maybeStop(sym)

      });
      //Edge binding end

      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 107210, function(sym, e) {
         maybeStop(sym)

      });
      //Edge binding end

      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 118350, function(sym, e) {
         maybeStop(sym)
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 124660, function(sym, e) {
         maybeStop(sym)

      });
      //Edge binding end

      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 133449, function(sym, e) {
         maybeStop(sym)
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 15726, function(sym, e) {
         maybeStop(sym)
