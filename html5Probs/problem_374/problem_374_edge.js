...
"stage": {
    ...
    content: {
            ...
            },
            {
                id: 'Text2',
                type: 'text',
                rect: ['118px', '30px','239px','20px','auto', 'auto'],
            ...
            },
            {
                id: 'Text3',
                type: 'text',
                rect: ['16px', '59px','435px','40px','auto', 'auto'],
            ...
            },
            {
                ...
                display: 'none',
                type: 'text',
                rect: ['338px', '422px','135px','37px','auto', 'auto'],
                text: "Choose (C)",
                align: "left",
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                { id: "eid168", tween: [ "style", "${_Answers}", "left", '37px', { fromValue: '37px'}], position: 2000, duration: 0 },
                { id: "eid169", tween: [ "style", "${_CodeCogsEqn_33}", "display", 'none', { fromValue: 'block'}], position: 2000, duration: 0 },
                { id: "eid170", tween: [ "style", "${_CodeCogsEqn_33}", "display", 'block', { fromValue: 'none'}], position: 31500, duration: 0 },
                { id: "eid29", tween: [ "style", "${_QuestionSound_Container}", "display", 'none', { fromValue: 'none'}], position: 0, duration: 0 },
                { id: "eid28", tween: [ "style", "${_Sound_Container}", "display", 'none', { fromValue: 'none'}], position: 0, duration: 0 },
                { id: "eid171", tween: [ "style", "${_Text6}", "display", 'none', { fromValue: 'none'}], position: 0, duration: 0 },
                { id: "eid172", tween: [ "style", "${_Text6}", "display", 'block', { fromValue: 'none'}], position: 37963, duration: 0 },
                { id: "eid167", tween: [ "style", "${_Answers}", "top", '341px', { fromValue: '341px'}], position: 2000, duration: 0 },
                { id: "eid173", trigger: [ function executeMediaFunction(e, data) { this._executeMediaAction(e, data); }, ['play', '${_question}', [] ], ""], position: 2000 },
                { id: "eid174", trigger: [ function executeMediaFunction(e, data) { this._executeMediaAction(e, data); }, ['play', '${_hint1}', [] ], ""], position: 23000 },
                { id: "eid175", trigger: [ function executeMediaFunction(e, data) { this._executeMediaAction(e, data); }, ['play', '${_answer}', [] ], ""], position: 33000 }            ]
        }
    }
},
"EButton": {
