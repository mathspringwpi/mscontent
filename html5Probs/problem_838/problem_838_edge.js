...
(function (compId) {
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            id: 'problem_picture',
                            type: 'image',
                            rect: ['100', '151', '211', '194', 'auto', 'auto'],
                        ...
                        },
                        {
                            id: 'AnswerCText',
                            type: 'text',
                            rect: ['71', '257', '101', '19px', 'auto', 'auto'],
                            text: "8",
                            align: "left",
                            font: ['Times New Roman, Times, serif', [14, "px"], "rgba(0,0,0,1)", "normal", "none", "normal", "break-word", ""]
                        },
                        {
                            id: 'AnswerBText',
                            type: 'text',
                            rect: ['71', '225', '112', '19px', 'auto', 'auto'],
                            text: "7",
                            align: "left",
                            font: ['Times New Roman, Times, serif', [14, "px"], "rgba(0,0,0,1)", "normal", "none", "normal", "break-word", ""]
                        },
                        ...
                        },
                        {
                            ...
                            display: 'none',
                            type: 'image',
                            rect: ['318', '51', '218', '238', 'auto', 'auto'],
                            fill: ["rgba(0,0,0,0)",'397/gif/VV_397d.gif','0px','0px']
                        },
                        {
                            id: 'Choose_D',
                            type: 'text',
                            rect: ['328', '313', '197px', '38px', 'auto', 'auto'],
                            opacity: '0',
                            text: "Choose (D)",
                            align: "left",
                            font: ['Arial, Helvetica, sans-serif', [16, ""], "rgba(14,114,33,1.00)", "700", "none", "normal", "break-word", ""]
                        },
                        {
                            id: 'answer',
                            display: 'none',
                ...
                timeline: {
                    ...
                    data: [
                        ...
                        [
                            ...
                            [ "eid175", "trigger", 2000, function executeMediaFunction(e, data) { this._executeMediaAction(e, data); }, ['play', '${question}', [] ] ],
                            [ "eid176", "trigger", 39000, function executeMediaFunction(e, data) { this._executeMediaAction(e, data); }, ['play', '${answer}', [] ] ]
                    ]
                }
            },
            "EButton": {
    ...
    if (!window.edge_authoring_mode) AdobeEdge.getComposition(compId).load("problem_838_edgeActions.js");
})("EdgeProblem");
