    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid175", trigger: [ function executeMediaFunction(e, data) { this._executeMediaAction(e, data); }, ['play', '${_question}', [] ], ""], position: 2000 },
                { id: "eid176", trigger: [ function executeMediaFunction(e, data) { this._executeMediaAction(e, data); }, ['play', '${_answer}', [] ], ""], position: 39000 }            ]
        }
    }
},
"EButton": {
