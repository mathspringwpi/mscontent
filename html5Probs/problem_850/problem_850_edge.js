...
"stage": {
    ...
    content: {
            ...
            },
            {
                id: 'Text',
                type: 'text',
                rect: ['25px', '38px','252px','82px','auto', 'auto'],
            ...
            },
            {
                id: 'Answers',
                type: 'rect',
                rect: ['17px', '159px','auto','auto','auto', 'auto'],
                transform: [[],[],[],['1.00641','1.1123']]
            },
            {
                id: 'Text4',
                type: 'text',
                rect: ['69px', '252px','59px','15px','auto', 'auto'],
                text: "$13.50",
                align: "left",
            ...
            },
            {
                id: 'Text6',
                type: 'text',
                rect: ['77px', '288px','51px','24px','auto', 'auto'],
                text: "$5.50",
                align: "left",
                font: ['Arial, Helvetica, sans-serif', 16, "rgba(0,0,0,1)", "normal", "none", "normal"]
            },
            {
                id: 'Text2',
                type: 'text',
                rect: ['69px', '175px','59px','24px','auto', 'auto'],
                text: "$28.00",
                align: "left",
                font: ['Arial, Helvetica, sans-serif', 16, "rgba(0,0,0,1)", "normal", "none", "normal"]
            },
            {
                id: 'Text3',
                type: 'text',
                rect: ['69px', '212px','74px','24px','auto', 'auto'],
                text: "$30.00",
                align: "left",
                font: ['Arial, Helvetica, sans-serif', 16, "rgba(0,0,0,1)", "normal", "none", "normal"]
            },
            {
                ...
                display: 'none',
                type: 'text',
                rect: ['201px', '343px','108px','28px','auto', 'auto'],
                text: "Choose (A)",
                align: "left",
            ...
            },
            {
                ...
                display: 'none',
                type: 'text',
                rect: ['185px', '159px','411px','18px','auto', 'auto'],
            ...
            },
            {
                ...
                display: 'none',
                type: 'text',
                rect: ['185px', '197px','346px','35px','auto', 'auto'],
            ...
            },
            {
                ...
                display: 'none',
                type: 'text',
                rect: ['185px', '235px','282px','35px','auto', 'auto'],
            ...
            },
            {
                ...
                display: 'none',
                type: 'text',
                rect: ['185px', '275px','118px','35px','auto', 'auto'],
                text: "Total = $28",
                align: "left",
                font: ['Arial, Helvetica, sans-serif', 20, "rgba(245,7,7,1.00)", "700", "none", "normal"]
            },
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid180", tween: [ "style", "${_Text8}", "display", 'block', { fromValue: 'none'}], position: 15000, duration: 0 },
                { id: "eid174", tween: [ "style", "${_Text8Copy2}", "display", 'none', { fromValue: 'none'}], position: 0, duration: 0 },
                { id: "eid182", tween: [ "style", "${_Text8Copy2}", "display", 'block', { fromValue: 'none'}], position: 18967, duration: 0 },
                { id: "eid28", tween: [ "style", "${_Sound_Container}", "display", 'none', { fromValue: 'none'}], position: 0, duration: 0 },
                { id: "eid175", tween: [ "style", "${_Text8Copy}", "display", 'none', { fromValue: 'none'}], position: 0, duration: 0 },
                { id: "eid181", tween: [ "style", "${_Text8Copy}", "display", 'block', { fromValue: 'none'}], position: 17000, duration: 0 },
                ...
                { id: "eid184", trigger: [ function executeMediaFunction(e, data) { this._executeMediaAction(e, data); }, ['play', '${_answer}', [] ], ""], position: 20920 }            ]
        }
    }
},
"EButton": {
