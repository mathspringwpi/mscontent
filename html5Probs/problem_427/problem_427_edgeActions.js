...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 36677, function(sym, e) {
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 64892, function(sym, e) {
         maybeStop (sym)

      });
      //Edge binding end

      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 72750, function(sym, e) {
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 50203, function(sym, e) {
         maybeStop (sym)
