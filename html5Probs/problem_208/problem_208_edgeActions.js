...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 96667, function(sym, e) {
         maybeStop(sym)
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 23405, function(sym, e) {
         maybeStop(sym)
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 26779, function(sym, e) {
         maybeStop(sym)
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 27000, function(sym, e) {
         //Hint 3
         //Sound begins playing in a few seconds

      });
      //Edge binding end

      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 74369, function(sym, e) {
         maybeStop(sym)
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 82250, function(sym, e) {
         maybeStop(sym)
