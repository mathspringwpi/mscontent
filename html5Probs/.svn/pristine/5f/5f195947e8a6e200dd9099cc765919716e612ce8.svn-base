...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 1323, function(sym, e) {
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 16654, function(sym, e) {
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 28390, function(sym, e) {
         playSound(sym,"hint3.ogg");

      });
      //Edge binding end

      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 40756, function(sym, e) {
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 49770, function(sym, e) {
         maybeStop(sym);

      });
      //Edge binding end

      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 59758, function(sym, e) {
         maybeStop(sym);

      });
      //Edge binding end

      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 79762, function(sym, e) {
         maybeStop(sym);

      });
      //Edge binding end

      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 101740, function(sym, e) {
         maybeStop(sym);

      });
      //Edge binding end

      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 115706, function(sym, e) {
         maybeStop(sym);

      });
      //Edge binding end

      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 147000, function(sym, e) {
         maybeStop(sym);
