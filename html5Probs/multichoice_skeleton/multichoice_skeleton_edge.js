...
"stage": {
    ...
    content: {
            ...
            },
            {
                id: 'AnswerB',
                type: 'group',
                rect: ['71', '454px','112','19','auto', 'auto'],
                c: [
                {
                    id: 'AnswerBText',
                    type: 'text',
                    rect: ['0px', '-15px','112px','19px','auto', 'auto'],
                    text: "Answer B Text",
                    align: "left",
                    font: ['Georgia, \'Times New Roman\', Times, serif', 14, "rgba(0,0,0,1)", "normal", "none", "normal"]
                }]
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid482", tween: [ "style", "${_Answers}", "left", '27px', { fromValue: '24px'}], position: 16500, duration: 3500, easing: "swing" },
                ...
                { id: "eid460", tween: [ "style", "${_Answers}", "top", '381px', { fromValue: '386px'}], position: 14500, duration: 5500, easing: "swing" },
                ...
                { id: "eid461", tween: [ "transform", "${_Answers}", "scaleY", '1.00535', { fromValue: '1.00535'}], position: 20000, duration: 0, easing: "swing" },
