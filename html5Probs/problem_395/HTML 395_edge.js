...
"stage": {
   ...
   content: {
         ...
         },
         {
            id:'Answers',
            type:'rect',
            rect:['48','258px','auto','auto','auto','auto']
         },
         {
         ...
         },
         {
            id:'Answer_A',
            type:'image',
            rect:['72px','269px','60px','30px','auto','auto'],
            fill:["rgba(0,0,0,0)",im+"Answer%20A.svg",'0px','0px']
         },
         {
            id:'Answer_B',
            type:'image',
            rect:['72px','305px','60px','30px','auto','auto'],
            fill:["rgba(0,0,0,0)",im+"Answer%20B.svg",'0px','0px']
         },
         {
            id:'Answer_C',
            type:'image',
            rect:['72px','342px','60px','30px','auto','auto'],
            fill:["rgba(0,0,0,0)",im+"Answer%20C.svg",'0px','0px']
         },
         {
            id:'Answer_D',
            type:'image',
            rect:['72px','379px','60px','30px','auto','auto'],
