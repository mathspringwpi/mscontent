...
"stage": {
    ...
    content: {
            ...
            },
            {
                ...
                transform: [[],[],[],['1.20032','1.12701']]
            },
            {
                id: 'AnswerDText',
                type: 'text',
                rect: ['76px', '346px','113px','20px','auto', 'auto'],
            ...
            },
            {
                id: 'AnswerCText',
                type: 'text',
                rect: ['77px', '305px','119px','19px','auto', 'auto'],
            ...
            },
            {
                id: 'AnswerBText',
                type: 'text',
                rect: ['77px', '270px','112px','19px','auto', 'auto'],
            ...
            },
            {
                id: 'AnswerAText',
                type: 'text',
                rect: ['78px', '232px','109px','19px','auto', 'auto'],
    ...
    states: {
        "Base State": {
            ...
            "${_Answers}": [
                ["style", "top", '217px'],
                ["transform", "scaleX", '1.20032'],
                ["transform", "scaleY", '1.12701'],
                ["style", "left", '38px']
            ],
            "${_Stage}": [
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid160", tween: [ "style", "${_Answers}", "top", '217px', { fromValue: '217px'}], position: 13000, duration: 0 },
                ...
                { id: "eid166", trigger: [ function executeMediaFunction(e, data) { this._executeMediaAction(e, data); }, ['play', '${_question}', [] ], ""], position: 2000 },
                { id: "eid167", trigger: [ function executeMediaFunction(e, data) { this._executeMediaAction(e, data); }, ['play', '${_answer}', [] ], ""], position: 27000 }            ]
        }
    }
},
"EButton": {
