...
"stage": {
    ...
    content: {
            dom: [
            {
                id: 'Question_Text',
                type: 'text',
                rect: ['15px', '30px','406px','56px','auto', 'auto'],
            ...
            },
            {
                id: 'Answers',
                type: 'rect',
                rect: ['7px', '173px','auto','auto','auto', 'auto'],
            ...
            },
            {
                ...
                type: 'image',
                rect: ['172px', '92px','167px','154px','auto', 'auto'],
            ...
            },
            {
                id: 'Choose_C',
                type: 'text',
                rect: ['169px', '256px','99px','20px','auto', 'auto'],
                text: "Choose (C)",
                align: "left",
            ...
            },
            {
                ...
                display: 'none',
                type: 'image',
                rect: ['362px', '124px','219px','221px','auto', 'auto'],
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                { id: "eid170", tween: [ "style", "${_VV_283d2}", "display", 'block', { fromValue: 'none'}], position: 19000, duration: 0 },
                ...
                { id: "eid171", trigger: [ function executeMediaFunction(e, data) { this._executeMediaAction(e, data); }, ['play', '${_question}', [] ], ""], position: 2000 },
                { id: "eid172", trigger: [ function executeMediaFunction(e, data) { this._executeMediaAction(e, data); }, ['play', '${_answer}', [] ], ""], position: 29000 }            ]
        }
    }
},
"EButton": {
