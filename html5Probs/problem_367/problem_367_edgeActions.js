...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 80000, function(sym, e) {
         sym.$("Sound_Container").html ("");
         var sound=$("<iframe type ='text/html' width='550' height='310' src='answerhint.ogg' frameborder='0'>" + "</iframe>");
         sym.$("Sound_Container").append(sound);
