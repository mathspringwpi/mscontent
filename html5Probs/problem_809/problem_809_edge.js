...
"stage": {
    ...
    content: {
            ...
            },
            {
                id: 'Answers',
                type: 'rect',
                rect: ['26px', '373px','auto','auto','auto', 'auto']
            },
            {
                id: 'AnswerDText',
                type: 'text',
                rect: ['73px', '498px','101px','20px','auto', 'auto'],
                text: "-13",
                align: "left",
            ...
            },
            {
                id: 'AnswerCText',
                type: 'text',
                rect: ['73px', '462px','101px','19px','auto', 'auto'],
                text: "13",
                align: "left",
                font: ['Times New Roman, Times, serif', 14, "rgba(0,0,0,1)", "normal", "none", "normal"]
            },
            {
                id: 'AnswerBText',
                type: 'text',
                rect: ['73px', '430px','112px','19px','auto', 'auto'],
                text: "-390",
                align: "left",
                font: ['Times New Roman, Times, serif', 14, "rgba(0,0,0,1)", "normal", "none", "normal"]
            },
            {
                id: 'AnswerAText',
                type: 'text',
                rect: ['73px', '395px','109px','19px','auto', 'auto'],
                text: "390",
                align: "left",
                font: ['Times New Roman, Times, serif', 14, "rgba(0,0,0,1)", "normal", "none", "normal"]
            },
            ...
            },
            {
                id: 'choose_B',
                type: 'text',
                rect: ['301px', '363px','156px','20px','auto', 'auto'],
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid297", trigger: [ function executeMediaFunction(e, data) { this._executeMediaAction(e, data); }, ['play', '${_question2}', [] ], ""], position: 2000 },
                { id: "eid298", trigger: [ function executeMediaFunction(e, data) { this._executeMediaAction(e, data); }, ['play', '${_hint1a}', [] ], ""], position: 12000 },
                { id: "eid299", trigger: [ function executeMediaFunction(e, data) { this._executeMediaAction(e, data); }, ['play', '${_hint1b}', [] ], ""], position: 16000 },
                { id: "eid300", trigger: [ function executeMediaFunction(e, data) { this._executeMediaAction(e, data); }, ['play', '${_hint1c}', [] ], ""], position: 25000 },
                { id: "eid301", trigger: [ function executeMediaFunction(e, data) { this._executeMediaAction(e, data); }, ['play', '${_hint1d}', [] ], ""], position: 48000 },
                { id: "eid302", trigger: [ function executeMediaFunction(e, data) { this._executeMediaAction(e, data); }, ['play', '${_hint1e}', [] ], ""], position: 64000 },
                { id: "eid303", trigger: [ function executeMediaFunction(e, data) { this._executeMediaAction(e, data); }, ['play', '${_hint2a}', [] ], ""], position: 71000 },
                { id: "eid304", trigger: [ function executeMediaFunction(e, data) { this._executeMediaAction(e, data); }, ['play', '${_hint2b}', [] ], ""], position: 80000 },
                { id: "eid305", trigger: [ function executeMediaFunction(e, data) { this._executeMediaAction(e, data); }, ['play', '${_hint2c}', [] ], ""], position: 91000 },
                { id: "eid306", trigger: [ function executeMediaFunction(e, data) { this._executeMediaAction(e, data); }, ['play', '${_hint3a}', [] ], ""], position: 103000 },
                { id: "eid307", trigger: [ function executeMediaFunction(e, data) { this._executeMediaAction(e, data); }, ['play', '${_hint3b}', [] ], ""], position: 121000 },
                { id: "eid308", trigger: [ function executeMediaFunction(e, data) { this._executeMediaAction(e, data); }, ['play', '${_answerhint1}', [] ], ""], position: 140000 },
                { id: "eid309", trigger: [ function executeMediaFunction(e, data) { this._executeMediaAction(e, data); }, ['play', '${_answerhint2}', [] ], ""], position: 150000 }            ]
        }
    }
},
"EButton": {
