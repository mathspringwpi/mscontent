...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 57750, function(sym, e) {
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 84897, function(sym, e) {
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 79250, function(sym, e) {
         maybeStop (sym)

      });
      //Edge binding end

      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 67250, function(sym, e) {
         // insert code here
         maybeStop (sym)
